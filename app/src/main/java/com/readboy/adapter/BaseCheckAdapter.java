...
public abstract class BaseCheckAdapter<D, VH extends BaseCheckViewHolder<D>> extends BaseAdapter<D, VH> implements
        View.OnClickListener, BaseCheckViewHolder.OnCheckedChangeListener {
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        updateCheckedState(position, buttonView.isChecked());
