...
public class MessageReceiver extends BroadcastReceiver {
    ...
    public static final String ACION_NOTIFY_FRIEND_REQUEST = "readboy.action.NOTIFY_FRIEND_REQUEST";
...
//                mNetWorkUtils.downLoadVoiceFile(mContext, (Conversation) msg.obj);
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        Log.e(TAG, "onReceive2: action = " + action);
        ...
        switch (action) {
            ...
            case ACTION_SEND_CAPTURE:
                ...
                break;
            case ACION_NOTIFY_FRIEND_REQUEST:
...
//                        getAllMessage(context);
                    ...
                    for (int i = 0; i < count; i++) {
                        ...
                        final Conversation conversation = parseConversation(messageInfo, context);
                    ...
                    if (count != 0 && !hasFile) {
                        ...
                        Log.i(TAG, "pushSucceed: count = " + count + ", hasFile = " + hasFile);
                    }
    ...
    private static Conversation parseConversation(String[] messageInfo, Context context) {
