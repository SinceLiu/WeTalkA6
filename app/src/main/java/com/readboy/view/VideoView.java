...
import com.readboy.utils.ScreenResolution;
...
public class VideoView extends SurfaceView {
    ...
    public static final int STATE_INITIALIZED = 1 << 1;
    public static final int STATE_IDLE = 1;
    public static final int STATE_PREPARING = 1 << 2;
    public static final int STATE_PREPARED = 1 << 3;
    public static final int STATE_PLAYING = 1 << 4;
    public static final int STATE_PAUSED = 1 << 5;
    public static final int STATE_STOPPED = 1 << 6;
    public static final int STATE_PLAYBACK_COMPLETED = 1 << 7;
     ...
     * 全屏
     */
    public static final int VIDEO_LAYOUT_FULL_SCREEN = 2;
    /**
     * 缩放参数，画面裁剪
     */
    public static final int VIDEO_LAYOUT_ZOOM = 3;

    private static final String TAG = "oubin_VideoView";
    private Uri mUri;
    ...
    /**
     * 是否正在加载，读取新的视频资源，外部设置连接{@link #setVideoURI(Uri)} )}
     * 到初始化MediaPlayer的时间。
    ...
    private int mLayoutType = VIDEO_LAYOUT_FULL_SCREEN;
...
//            toastErrorMessage(what, extra);
    ...
    private OnVideoSizeChangedListener mVideoSizeChangedListener = new OnVideoSizeChangedListener() {
        ...
        public void onVideoSizeChanged(MediaPlayer mp, int width, int height) {
            ...
            Log.i(TAG, "onVideoSizeChanged: video width = " + mVideoWidth + ", height = " + mVideoHeight);
            setLayout();
        }
    };
            ...
            if (!isLoadingNewUri) {
                if (delayLoad || mSaveState == STATE_PREPARING
                    ...
                    if (delayLoad || !mIsPlayUrl || isConnected(VideoView.this.getContext())) {
                        Log.i(TAG, "surfaceCreated: delayLoad play video.");
                        openVideo();
                    }
                }
            }
...
//            release(true);
    ...
    public void setLayout(int layout, float videoScale, float aspectRatio) {
        ...
        Log.i(TAG, "setLayout: 1 >> " + videoShowW + ", " + videoShowH);
        ...
        Log.i(TAG, "setLayout: 2 >> " + videoShowW + ", " + videoShowH);
        ...
        mLayoutType = layout;
        Log.i(TAG, "setLayout: video show w = " + videoShowW + ", h = " + videoShowH);
...
//            mUri = null;
    ...
    private void openVideo() {
        ...
        if (mUri == null || mSurfaceHolder == null) {
            Log.i(TAG, "openVideo: mSurfaceHolder is null, delay play.");
...
//        getHolder().setType(SurfaceHolder.SURFACE_TYPE_PUSH_BUFFERS);
        ...
        requestFocus();
        videoPlayerListeners = Collections.synchronizedList(new LinkedList<>());
    }
